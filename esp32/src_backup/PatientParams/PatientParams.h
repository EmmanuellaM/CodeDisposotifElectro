...
public:
    ...
    // ==========================================
    // DISPLAY METHOD (Debug/Test)
    // ==========================================
    
    // Display parameters in Serial Monitor (no network send)
    ...
    // NEW: Wait for response via UART
    static String wait_response_uart(unsigned long timeout_ms = 5000);
