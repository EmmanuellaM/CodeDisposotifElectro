...
void PatientParams::set_age(int age) {
    getInstance()->_age = age;
}
...
String PatientParams::_formatData() {
    // Format: (id : <valeur>, age : <valeur>, poids : <valeur>, pression : <valeur>, température : <valeur>, saturation : <valeur>)
    String data = "(";
    data += "id : " + _id + ", ";
    data += "age : " + String(_age) + ", ";
...
// ==========================================
// DISPLAY IMPLEMENTATION (Debug/Test)
// ==========================================

void PatientParams::display_parameters() {
    Serial.println("\n========== PATIENT PARAMETERS ==========");
